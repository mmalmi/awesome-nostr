...
- [iris](https://github.com/irislib/iris-messenger)![stars](https://img.shields.io/github/stars/irislib/iris-messenger.svg?style=social) - A nostr web client
  ...
  - [iOS Testflight](https://testflight.apple.com/join/5xdoDCmG) - wrapped for iOS
  - [Android](https://play.google.com/store/apps/details?id=to.iris.twa) - wrapped for Android
